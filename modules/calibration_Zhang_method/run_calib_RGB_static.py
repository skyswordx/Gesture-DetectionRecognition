# -*- coding: utf-8 -*-
"""
Calibrate the RGB Camera with static images.

This script processes a set of pre-captured images from a folder
to perform camera calibration. It uses the dedicated OpenCV model.
"""
...
def main():
    ...
    # 路径配置
    img_dir = os.path.join(script_dir, "pic/RGB_camera_calib_img")
